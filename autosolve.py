...
def get_solution_2(mat):
    ...
    highest_score, high_score_moves = get_recur_best_score(mat, 0, 3)
...
def calculate_average_of_sampled_filling(mat, current_step, max_depth):
    ...
    if logic.score_number_of_empty_squares(mat) <= sample_amount:
        return calculate_average_of_random_filling(mat, current_step, max_depth)
    else:
        sample_count = 0
